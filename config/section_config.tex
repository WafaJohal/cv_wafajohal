...
\definecolor{LightGray}{RGB}{230,232,235} % this 
\definecolor{LightBlue}{RGB}{214,232,253} % this
\definecolor{DarkerBlue}{RGB}{50,60,115}



% Define a macro to combine section number and title with background color
\newcommand{\subsectionformat}[1]{%
  \colorbox{LightBlue!100}{\parbox{\dimexpr\textwidth-2\fboxsep}{#1}}%
}
